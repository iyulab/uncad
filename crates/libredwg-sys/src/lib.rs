//! Raw FFI bindings to the LibreDWG C sources (a vendored subset of the
//! real upstream project at `lib/libredwg`, GPLv3+, carrying five local
//! patches marked `uncad local patch`; see `NOTICE.md` in this crate and
