...
//! `DWG_ERR_IOERROR` (see docs/VLM_INVESTIGATION.md). The fixture is the
//! LibreDWG corpus's one-entity `circle.dwg`; the assertions stay
//! reference-free (a count, and parse-vs-parse_bytes equality).
